...
-- depends_on: {{ source('public', '_airbyte_raw_covidcovid_epidemiology') }}
select
...
from {{ source('public', '_airbyte_raw_covidcovid_epidemiology') }} as table_alias
-- covidcovid_epidemiology
where 1 = 1
